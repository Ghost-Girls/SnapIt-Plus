...
### Window Snap Delay in High DPI Environments
Window snapping may have slight delays in some high-DPI multi-monitor configurations. This is related to DPI scaling round-trip calculations.
