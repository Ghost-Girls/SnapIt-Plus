...
public partial class SnapOverlayEditor : UserControl
{
    ...
    public LayoutOverlay GetOverlay()
    {
        ...
        {
            Point = new SnapIt.Common.Graphics.Point((float)Margin.Left, (float)Margin.Top),
            Size = new SnapIt.Common.Graphics.Size((float)Width, (float)Height),
            MiniOverlay = new LayoutOverlay
            {
                Point = new SnapIt.Common.Graphics.Point((float)(Margin.Left + MiniOverlay.Margin.Left), (float)(Margin.Top + MiniOverlay.Margin.Top)),
                Size = new SnapIt.Common.Graphics.Size((float)MiniOverlay.Width, (float)MiniOverlay.Height)
            }
        };
    }
